...
The project is designed to showcase practical SQL, ETL, data modeling, and analytics skills that are commonly used in real-world data engineering and data analyst roles.
...
4. Create Fact and Dimension tables in the Gold layer.
5. Perform business analysis using SQL queries.
6. Connect the Gold layer to Power BI for dashboard creation.
...
* Expand analytical reports and KPIs.
...
This project is part of my Data Analytics portfolio and demonstrates practical experience with SQL, ETL, Data Warehousing, and Business Intelligence concepts.
